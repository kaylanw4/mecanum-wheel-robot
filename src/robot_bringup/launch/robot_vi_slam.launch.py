#!/usr/bin/env python3
"""
Phase 3: Complete Robot with ZED VI-SLAM Integration
Launches robot hardware with ZED2i as primary odometry source
File: src/robot_bringup/launch/robot_vi_slam.launch.py
"""
...
def generate_launch_description():
    ...
    debug_config_info = LogInfo(
        msg=['Using ZED VI-SLAM config: ', zed_vi_slam_config]
    )
    ...
    # RViz with VI-SLAM visualization (conditional)
