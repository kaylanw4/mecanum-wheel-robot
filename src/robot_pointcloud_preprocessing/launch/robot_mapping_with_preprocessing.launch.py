#!/usr/bin/env python3
"""
ZED Mapping Mode with Point Cloud Preprocessing - Phase 2: Statistical Outlier Removal
Based on robot_mapping.launch.py with added statistical outlier filtering
File: src/robot_pointcloud_preprocessing/launch/robot_mapping_with_preprocessing.launch.py
"""
...
def generate_launch_description():
    ...
    # Launch arguments (same as robot_mapping.launch.py)
    ...
    # Robot description with VI-SLAM URDF (same as original)
    ...
    # Robot state publisher (same as original)
    ...
    # Joint state publisher (same as original)
    ...
    # PS4 Controller for joy input (same as original)
    joy_node = Node(
        package='joy',
        executable='joy_node',
        name='joy_node',
    ...
    # Enhanced Yahboom joystick controller (same as original)
    ...
    # Yahboom hardware driver (same as original)
    yahboom_driver = Node(
    ...
    # ZED2i Camera with SPATIAL MAPPING enabled (same as original)
    ...
    # RViz with mapping visualization (MODIFIED to use original config)
    ...
    return LaunchDescription([
        ...
        # NEW: Point cloud preprocessing
        preprocessor_node,
        
        # Visualization (using proven working config)
        rviz_node,
    ])